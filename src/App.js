...
//In ES6, when we have an object with a key and value with the same name, we can use the shorthand syntax as above
//it's actually addTodo: addTodo before the modification